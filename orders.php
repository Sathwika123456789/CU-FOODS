...
<section class="orders">
   ...
   <h1 class="title">your customised orders</h1>
   ...
   <div class="box">
      ...
      <p> Order status : <span style="color:<?php if($fetch_custom_orders['payment_status'] == 'pending'){ echo 'red'; }else{ echo 'green'; }; ?>"><?= $fetch_custom_orders['payment_status']; ?></span> </p>
   </div>
   <?php
      }
      }else{
